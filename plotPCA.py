...
if int(matplotlib.__version__[0]) < 2:
    ...
    sys.stderr.write(
        "\tCurrent version of Matplotlib is {}.\n".format(matplotlib.__version__)
    )
    OLD_VERSION = True
else:
    OLD_VERSION = False
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "prefix", help="File prefix (prefix.eigenvec & prefix.eigenval)"
    )
    ...
    parser.add_argument(
        "-o", "--outprefix", help="Output will be stored in 'outprefix.png'."
    )
    ...
    parser.add_argument(
        ...
        "--column",
        type=int,
        help="Column in family file for grouping (1-6).",
        default=6,
    )
    parser.add_argument(
        "-s", "--samples", help="List of samples (2 columns: sample group)."
    )
